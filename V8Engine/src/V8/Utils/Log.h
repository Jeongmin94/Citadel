...
#define CORE_ERROR(...) ::V8::Log::GetCoreLogger()->error(__VA_ARGS__)
#define CORE_WARN(...) ::V8::Log::GetCoreLogger()->warn(__VA_ARGS__)
#define CORE_INFO(...) ::V8::Log::GetCoreLogger()->info(__VA_ARGS__)
#define CORE_DEBUG(...) ::V8::Log::GetCoreLogger()->debug(__VA_ARGS__)
#define CORE_TRACE(...) ::V8::Log::GetCoreLogger()->trace(__VA_ARGS__)
